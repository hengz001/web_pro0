...
<%--                    <input id="ciphertextDes" name="ciphertextDes" type="text" style="width:600px" class="easyui-textbox" data-options="prompt:'请输入16进制数据'">--%>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a id="btn_encrypt_des" class="easyui-linkbutton" style="width:100px;" onclick="form_opt_des(1,'${pageContext.request.contextPath}/des/encrypt')">加密</a>
                    <a id="btn_decrypt_des" class="easyui-linkbutton" style="width:100px;" onclick="form_opt_des(0,'${pageContext.request.contextPath}/des/decrypt')">解密</a>
                </td>
            </tr>
        </table>
    </form>
